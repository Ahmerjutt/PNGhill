...
$title = '';
if ($_GET['ex'] == 'zip') {
  if ($dlink->zip_status == 'pnghill') {
    $ddlink = base_url($dlink->dlink_zip);
    $title = 'www.pnghill.com_'.$dlink->title.'.zip';
  }else{
    $ddlink = $dlink->dlink_zip;
    $title = 'www.pnghill.com_'.$dlink->title.'.zip';
  }
}else{
  $ddlink = base_url($dlink->dlink_image);
  $title = 'www.pnghill.com_'.$dlink->title.'.'.$_GET['ex'];
}
...
<section class="containerp deeman">
   <div class="row" style="padding:20px">
      <div class="col s12 m5 l4 center-align">
        <span class="maincc">
          <img class="prevdimg" src="<?=base_url($dlink->image_path)?>" alt="">
        </span>
      </div>
      <div class="col s12 m7 l8 center-align">
         <div class="ttdd">
           ...
           <?php else: ?>
             <p>this link has been expired <a href="<?=base_url('freepng/'.$dlink->slug)?>">try again</a></p>
      ...
      <div class="img-list-pd">
        ...
        <div class="img-detail">
          <h3 class="img-detail-title">
            <a href="<?=$value->slug?>" style="text-transform:capitalize" class="turncate"><?=$value->title?></a></h3>

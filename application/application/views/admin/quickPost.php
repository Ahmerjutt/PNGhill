<?php 
   ...
   ?>
<main>
  <h5 class="center-align">Quick Post</h5>
  <div class="row">
    <div class="input-field col s10">
       <input id="linkww" type="text" class="validate" placeholder="URl to Post">
    </div>
    <div class="input-field col s2">
       <a class="waves-effect waves-light btn" id="checkit">Check it</a>
    </div>
  </div>
</main>
<style media="screen">
  .ddiv{pointer-events: none;opacity: 0.2;}
</style>
<main class="ddiv">
      ...
      <div class="row">
         <div class="col s8">
            ...
            <div class="col s6">
               ...
               <input type="text" id="imgeww" placeholder="image url" value="">
            </div>
         ...
         <div class="col s4 center-align">
            ...
            <a href="#" class="btn waves-effect" style="margin-bottom:20px;" id="qPublish">Publish</a>
